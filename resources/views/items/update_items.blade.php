                                    ...
                                    <form action="{{ url('items/update_items/' . $items->no) }}" method="post">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control" id="inputEmail4"
                                                    name="description_2" value="{{ $items->description_2 }}">
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label for="inputSelesperson"
                                                    name="salesperson_code">item_group_code</label>
                                                <input type="text" class="form-control" id="inputEmail4"
                                                    name="item_group_code" value="item_group_code">
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label for="inputSelesperson"
                                                    name="salesperson_code">item_category_code</label>
                                                <input type="text" class="form-control" id="inputEmail4"
                                                    name="item_category_code" value="item_category_code">
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label for="inputSelesperson" name="salesperson_code">unit_price</label>
                                                <input type="text" class="form-control" id="inputEmail4"
                                                    name="unit_price" value="{{ $items->unit_price }}">
                                            </div>
