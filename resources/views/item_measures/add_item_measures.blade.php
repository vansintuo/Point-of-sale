                                    ...
                                    <div class="col-12 grid-margin">
                                          <div class="card">
                                                <div class="card-body">
                                                      ...
                                                      <form action="{{url('item_unit_of_measures/insert_item_measures')}}" method="post">

                                                            @csrf
                                                            <div class="form-row">
                                                                  <div class="form-group col-md-6">
                                                                        <label for="input" name="email">Item_no</label>
                                                                        <input type="TEXT" class="form-control" id="inputNo" name="item_no" list="items" >
                                                                        <datalist id="items">
                                                                        @foreach($item_no as $data)
                                                                  ...
                                                                  <div class="form-group col-md-6">
                                                                        ...
                                                                        <input type="TEXT" class="form-control" id="inputEmail4" name="unit_of_measure_code">
                                                                  </div>
                                                                  <div class="form-group col-md-6">
                                                                        <label for="inputName" name="name">identifier_code</label>
                                                                        <input type="text" class="form-control" id="inputName" name="identifier_code">
                                                                  </div>
                                                                  <div class="form-group col-md-6">
                                                                  ...
                                                                  <div class="form-group col-md-6">
                                                                        ...
                                                                        <input type="text" class="form-control" id="inputEmail4" name="description_2">
                                                                  </div>
                                                                  <div class="form-group col-md-6">
                                                                        <label for="inputSelesperson" name="salesperson_code">qty_per_unit</label>
                                                                        <input type="text" class="form-control" id="inputEmail4" name="item_group_code">
                                                                  </div>
                                                                  <div class="form-group col-md-6">
